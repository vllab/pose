...
detection_layer parse_detection(list *options, size_params params)
{
	...
	int miss = option_find_int(options, "miss", 1);
	int numgt = option_find_int(options, "numgt", 1);
    detection_layer layer = make_detection_layer(params.batch, params.inputs, num, side, classes, coords, rescore, miss, numgt);
